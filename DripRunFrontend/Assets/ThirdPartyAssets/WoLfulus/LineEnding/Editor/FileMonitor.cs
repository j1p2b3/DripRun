    ...
    public class FileMonitor
    {
        ...
        static FileMonitor()
        {
            EditorApplication.delayCall += () =>
            {
                ...
                UnityEditor.Menu.SetChecked(MenuWindows, false);
                UnityEditor.Menu.SetChecked(MenuUnix, false);
                UnityEditor.Menu.SetChecked(MenuMac, false);

                var type = EditorPrefs.GetString(ConfigurationId);
                if (type == "win")
                {
                    UnityEditor.Menu.SetChecked(MenuWindows, true);
                }
                else if (type == "unix")
                {
                    UnityEditor.Menu.SetChecked(MenuUnix, true);
                }
                else if (type == "mac")
                {
                    UnityEditor.Menu.SetChecked(MenuMac, true);
                }
            };
        }
